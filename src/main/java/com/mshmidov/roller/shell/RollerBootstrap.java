...
public class RollerBootstrap {
	...
	public static void main(String[] args, ApplicationContext parent) throws IOException {
		sw.start();
		ExitShellRequest exitShellRequest;
		try {
			bootstrap = new RollerBootstrap(args, parent, CONTEXT_PATH);
	...
	public RollerBootstrap(String[] args, ApplicationContext parent, String[] contextPath) {
		try {
		...
		ctx = new GenericApplicationContext(parent);
